...
namespace PdfScribeCore
{
    ...
    public class PdfScribeInstaller
    {
        ...
        private readonly String logEventSourceNameDefault = "VoiceX";

        const string ENVIRONMENT_64 = "Windows x64";
        const string PRINTERNAME = "VoiceX Printer";
        const string DRIVERNAME = "VoiceX Virtual Printer";
        const string HARDWAREID = "VoiceX_Driver0101";
        const string PORTMONITOR = "VoiceX";
        const string MONITORDLL = "redmon64pdfscribe.dll";
        const string PORTNAME = "VOICEX:";
        ...
        public PdfScribeInstaller()
        {
            ...
            this.logEventSource.Switch = new SourceSwitch("VoiceXCoreAll");
...
#endif
        public bool IsPrinterDriverInstalled(String driverName)
        {

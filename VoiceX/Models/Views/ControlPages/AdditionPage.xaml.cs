    ...
    public sealed partial class AdditionPage : Page
    {
        ...
        public void ReloadCore(bool flag)
        {
            ...
            if (flag)
            {
                ...
                CoreService.Instance.LogIn(App.AccountData.Data.Sip_Settings.Sip_username.ToString(), App.AccountData.Data.Sip_Settings.Sip_secret, App.AccountData.Data.Sip_Settings.Sip_server, NewAdress.Text, transportType);
            }
            else
            {
                ...
                CoreService.Instance.ReloadCore(); 
                CoreService.Instance.CoreStart(CoreApplication.GetCurrentView().CoreWindow.Dispatcher);
                CoreService.Instance.LogIn(App.AccountData.Data.Sip_Settings.Sip_username.ToString(), App.AccountData.Data.Sip_Settings.Sip_secret, App.AccountData.Data.Sip_Settings.Sip_server, "sip:rsip.x-cloud.info", transportType);
            }
        }

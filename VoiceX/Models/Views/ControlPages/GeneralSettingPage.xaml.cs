    ...
    public sealed partial class GeneralSettingPage : Page
    {
        ...
        public void ReloadCore(TransportType type)
        {
            ...
            if (ApplicationData.Current.LocalSettings.Values.Keys.Contains("NewAdress"))
            {
                ...
                {
                    CoreService.Instance.LogIn(App.AccountData.Data.Sip_Settings.Sip_username.ToString(), App.AccountData.Data.Sip_Settings.Sip_secret, App.AccountData.Data.Sip_Settings.Sip_server, ApplicationData.Current.LocalSettings.Values["NewAdress"].ToString(), type);
                }
                else
                {
                    CoreService.Instance.LogIn(App.AccountData.Data.Sip_Settings.Sip_username.ToString(), App.AccountData.Data.Sip_Settings.Sip_secret, App.AccountData.Data.Sip_Settings.Sip_server, "sip:rsip.x-cloud.info", type);
                }
            }
            else
            {

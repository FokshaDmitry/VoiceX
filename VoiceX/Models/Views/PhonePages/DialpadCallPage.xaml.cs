...
namespace VoiceX.Views.PhonePages
{
    ...
    public sealed partial class DialpadCallPage : Page
    {
        ...
        private void CallButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                CoreService.Instance.Call($"{NumberFild.Text}");
                NumberFild.Text = "";
        ...
        private void ContactList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (callItem != null)
            {
                CoreService.Instance.Call($"{callItem.UserPhone}");
                NumberFild.Text = "";
                ContactList.Items.Clear();
                Frame.Navigate(typeof(ActivCallPage), phonePage);
            }
        ...
        private void NumberFild_KeyDown(object sender, Windows.UI.Xaml.Input.KeyRoutedEventArgs e)
        {

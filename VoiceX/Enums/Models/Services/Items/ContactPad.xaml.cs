...
namespace VoiceX.Items
{
    ...
    public sealed partial class ContactPad : ListBoxItem
    {
        ...
        public ContactPad(string UserName, string UserPhone, bool transfer)
        {
            ...
            if (PhonePage.CallAdtess.Contains(UserPhone))
            {
        ...
        private void Select_Click(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            ...
            {
                if (PhonePage.SelectContacts.Contains(UserPhone))
                {
                    PhonePage.SelectContacts.Remove(UserPhone);
                }
                else
                {
                    PhonePage.SelectContacts.Add(UserPhone);
                }
            }
            else
            {
        ...
        {
            PhonePage.currentCall?.Transfer(UserPhone);
        }
    }
}
